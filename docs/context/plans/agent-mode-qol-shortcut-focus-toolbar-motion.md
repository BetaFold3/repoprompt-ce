...
Status: T1 shortcut authority is implemented and validated; T3 implementation and automated validation are complete, with the live first-responder/caret check pending; T2, T4, and T5 remain pending.
