...
/// Capture of `https://developers.openai.com/api/docs/pricing.md` from 2026-09-15
/// (`ETag: "9c9c657012f2a8a709e5333323e8e04f"`, `Last-Modified: Tue, 15 Sep 2026 02:21:17 GMT`),
/// identical to `prompt-exports/openai-pricing-evidence/pricing.md` except that trailing
/// whitespace is stripped from every line. The four-space indentation below is the multiline
/// literal indentation stripped by Swift, so the string value keeps the document at column 0.
enum OpenAIPricingDocumentFixture {
    static let officialCapture20260915 = #"""
    # Pricing
