...
final class ToolCatalogSnapshotTests: XCTestCase {
    ...
    func testCodingAgentPromptManifestMatchesRegisteredSchemas() async throws {
        ...
        XCTAssertTrue(batchDescription.contains("Requires an idle Oracle tab"))
        XCTAssertTrue(batchDescription.contains("only after every lane finishes"))
        XCTAssertTrue(batchDescription.contains("not steerable"))
        XCTAssertTrue(batchDescription.contains("timeout_seconds"))
    ...
    private static let expectedSignatures: [String] = [
        ...
        "10|ask_oracle|enabled=true|ann=title=nil,readOnly=false,destructive=false,idempotent=nil,openWorld=false|desc=7e6499c8fe7c1774eb3d8624fa146d06a999b683bc804f5e0e94b20c16980014|schema=f66b7c7cc5adf20b878c146844bd0f5d16c7486b16f2d9f9c5d87ef3a3c21846",
