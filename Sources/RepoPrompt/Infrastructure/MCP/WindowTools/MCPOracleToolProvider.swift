        ...
        runtime.tool(
            ...
            inputSchema: .object(
                properties: [
                    ...
                    "new_chat": .boolean(
                        description: "Start a new chat session (default: false). Required for each independent parallel lane. When multiple compatible presets exist, new chats require an explicit model."
                    ),
                    "model": .string(
        ...
        runtime.tool(
            ...
            inputSchema: .object(
                properties: [
                    ...
                    "new_chat": .boolean(
                        description: "Start a new chat session (default: false; discouraged). Cannot be combined with chat_id."
                    ),
                    "model": .string(
