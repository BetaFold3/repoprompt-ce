...
public enum ClaudeCompatibleModelCatalog {
    ...
    private static let claudeModels: [StaticModel] = [
        StaticModel(
            ...
            description: "Claude Fable 5.1. Anthropic's most capable widely released model for demanding reasoning and long-horizon agentic work.",
            supportsXHigh: true
        ),
        StaticModel(
            rawValue: fable5Raw,
        ...
        StaticModel(
            ...
            description: "Pinned Claude Opus 5.5. Opus-tier capability for complex reasoning and architecture.",
            supportsXHigh: true
        ),
        StaticModel(
            rawValue: opus5Raw,
            displayName: "Opus 5",
            description: "Pinned Claude Opus 5. Opus-tier capability for complex reasoning and architecture.",
            supportsXHigh: true
        ),
        StaticModel(
            rawValue: opus47Raw,
