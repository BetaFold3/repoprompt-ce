...
func parseCLIMode(version: String) -> CLIMode {
...
func printVersion(version: String) {
    print("\(cliDisplayCommand()) (repoprompt-mcp) \(version)")
}
