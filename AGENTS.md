...
| Oracle remote-client models (Cursor/OMP), Cursor parameter-catalog durability, or `list_agents` parameter metadata | `Sources/RepoPrompt/Infrastructure/AI/Providers/Cursor/**`, `Sources/RepoPrompt/Infrastructure/AI/Providers/OhMyPi/**`, Oracle preset pickers | [Oracle remote-models plan](docs/context/plans/oracle-remote-models-cursor-catalog.md) | duel-settled plan for OMP Oracle presets and Cursor catalog hardening |
